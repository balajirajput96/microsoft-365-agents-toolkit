...
public class TeamsBotSsoPromptTest
{
    ...
    public async Task TeamsBotSsoPromptBeginDialogShouldSuccess()
    {
        ...
        .AssertReply(activity =>
        {
            ...
            Assert.AreEqual(mockAuthenticationResult.ExpiresOn.ToString(), response.Expiration.ToString());
        })
        .StartTestAsync();
    }
    ...
    public async Task TeamsBotSsoPromptWithEmptyScopeShouldReturnSsoToken()
    {
        ...
        .AssertReply(activity =>
        {
            ...
            Assert.AreEqual(expectedSsoExpiration.ToString(), response.Expiration.ToString());
        })
        .StartTestAsync();
    }

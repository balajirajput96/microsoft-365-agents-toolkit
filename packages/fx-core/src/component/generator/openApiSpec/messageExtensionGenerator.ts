...
export class MessageExtensionWithExistingApiSpecGenerator extends DefaultTemplateGenerator {
  componentName = "me-with-existing-api-generator";

  public override activate(context: Context, inputs: Inputs): boolean {
    return TemplateNames.MessageExtensionWithExistingApiSpec == inputs[QuestionNames.TemplateName];
  }
  ...
  public override async getTemplateInfos(
    ...
    return getTemplateInfosFromApiSpec(context, inputs, ProjectType.SME, actionContext);
  }

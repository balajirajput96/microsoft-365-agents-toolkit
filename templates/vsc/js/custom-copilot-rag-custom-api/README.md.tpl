...
The app template is built using the [Teams AI library V2](https://aka.ms/teams-ai-library-v2), which provides the capabilities to build AI-based applications.
